...
- Auto Fruit: nhặt trái rơi + bỏ vào rương, bay sang trái (toggle dưới HUD)
...
autoBtn.Parent = hud
autoBtn.Size = UDim2.new(1, -10, 0, 26)
autoBtn.Position = UDim2.new(0, 5, 1, -30)
autoBtn.BackgroundColor3 = Color3.fromRGB(30,30,40)
autoBtn.Text = "🍎 Auto Fruit: OFF"
autoBtn.TextColor3 = Color3.fromRGB(240,240,255)
autoBtn.Font = Enum.Font.GothamBold
autoBtn.TextSize = 14
local abCorner = Instance.new("UICorner", autoBtn)
abCorner.CornerRadius = UDim.new(0, 8)

local autoEnabled = false
autoBtn.MouseButton1Click:Connect(function()
    autoEnabled = not autoEnabled
    autoBtn.Text = autoEnabled and "🍎 Auto Fruit: ON" or "🍎 Auto Fruit: OFF"
end)
    ...
    while true do
        if autoEnabled then
            ...
            if char and char:FindFirstChild("HumanoidRootPart") then
                ...
                -- Bay sang trái
                hrp.CFrame = hrp.CFrame * CFrame.new(-2, 0, 0)
                -- Tìm trái cây rơi
...
local cPing, vPing, sPing = mkCard("Ping (ms)"); cPing.Parent = body
...
local cNetOut, vNetOut, sNetOut = mkCard("Network Out (KB/s)"); cNetOut.Parent = body
